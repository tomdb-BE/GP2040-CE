...
std::string setAddonOptions()
{
	...
	addonOptions.creditLedsAddonEnabled  =  doc["creditLedsAddonEnabled"];
	addonOptions.creditLedsStartPin1		=  doc["creditLedsStartPin1"] == -1 ? 0xFF : doc["creditLedsStartPin1"];
	addonOptions.creditLedsStartPin2		=  doc["creditLedsStartPin2"] == -1 ? 0xFF : doc["creditLedsStartPin2"];
	//addonOptions.creditLedsStartPin3		=  doc["creditLedsStartPin3"] == -1 ? 0xFF : doc["creditLedsStartPin3"];
	//addonOptions.creditLedsStartPin4		=  doc["creditLedsStartPin4"] == -1 ? 0xFF : doc["creditLedsStartPin4"];
	addonOptions.creditLedsCoinPin1		=  doc["creditLedsCoinPin1"] == -1 ? 0xFF : doc["creditLedsCoinPin1"];
	addonOptions.creditLedsCoinPin2		=  doc["creditLedsCoinPin2"] == -1 ? 0xFF : doc["creditLedsCoinPin2"];
	//addonOptions.creditLedsCoinPin3		=  doc["creditLedsCoinPin3"] == -1 ? 0xFF : doc["creditLedsCoinPin3"];
	//addonOptions.creditLedsCoinPin4		=  doc["creditLedsCoinPin4"] == -1 ? 0xFF : doc["creditLedsCoinPin4"];
	addonOptions.creditLedsMarqueePin	=  doc["creditLedsMarqueePin"] == -1 ? 0xFF : doc["creditLedsMarqueePin"];
	addonOptions.creditLedsExtStartPin	=  doc["creditLedsExtStartPin"] == -1 ? 0xFF : doc["creditLedsExtStartPin"];
	addonOptions.creditLedsExtCoinPin	=  doc["creditLedsExtCoinPin"] == -1 ? 0xFF : doc["creditLedsExtCoinPin"];
	addonOptions.creditLedsStartBrightness	=  (float)doc["creditLedsStartBrightness"] / 100 * 255;
	addonOptions.creditLedsCoinBrightness	=  (float)doc["creditLedsCoinBrightness"] / 100 * 255;
	addonOptions.creditLedsMarqueeBrightness	=  (float)doc["creditLedsMarqueeBrightness"] / 100 * 255;
...
std::string getAddonOptions()
{
	...
	doc["creditLedsAddonEnabled"] = addonOptions.creditLedsAddonEnabled;
	doc["creditLedsStartPin1"] = addonOptions.creditLedsStartPin1 == 0xFF ? -1 : addonOptions.creditLedsStartPin1;
	doc["creditLedsStartPin2"] = addonOptions.creditLedsStartPin2 == 0xFF ? -1 : addonOptions.creditLedsStartPin2;
	//doc["creditLedsStartPin3"] = addonOptions.creditLedsStartPin3 == 0xFF ? -1 : addonOptions.creditLedsStartPin3;
	//doc["creditLedsStartPin4"] = addonOptions.creditLedsStartPin4 == 0xFF ? -1 : addonOptions.creditLedsStartPin4;
	doc["creditLedsCoinPin1"] = addonOptions.creditLedsCoinPin1 == 0xFF ? -1 : addonOptions.creditLedsCoinPin1;
	doc["creditLedsCoinPin2"] = addonOptions.creditLedsCoinPin2 == 0xFF ? -1 : addonOptions.creditLedsCoinPin2;
	//doc["creditLedsCoinPin3"] = addonOptions.creditLedsCoinPin3 == 0xFF ? -1 : addonOptions.creditLedsCoinPin3;
	//doc["creditLedsCoinPin4"] = addonOptions.creditLedsCoinPin4 == 0xFF ? -1 : addonOptions.creditLedsCoinPin4;
	doc["creditLedsMarqueePin"] = addonOptions.creditLedsMarqueePin == 0xFF ? -1 : addonOptions.creditLedsMarqueePin;
	doc["creditLedsExtStartPin"] = addonOptions.creditLedsExtStartPin == 0xFF ? -1 : addonOptions.creditLedsExtStartPin;
	doc["creditLedsExtCoinPin"] = addonOptions.creditLedsExtCoinPin == 0xFF ? -1 : addonOptions.creditLedsExtCoinPin;
	doc["creditLedsStartBrightness"] = (uint8_t)((float)addonOptions.creditLedsStartBrightness / 255 * 100);
	doc["creditLedsCoinBrightness"] = (uint8_t)((float)addonOptions.creditLedsCoinBrightness / 255 * 100);
	doc["creditLedsMarqueeBrightness"] =  (uint8_t)((float)addonOptions.creditLedsMarqueeBrightness / 255 * 100);
