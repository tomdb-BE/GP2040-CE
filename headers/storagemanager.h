...
struct AddonOptions {
	...
	uint8_t creditLedsAddonEnabled;
	uint8_t	creditLedsStartPin1;
	uint8_t	creditLedsStartPin2;	
	//uint8_t	creditLedsStartPin3;
	//uint8_t	creditLedsStartPin4;
	uint8_t	creditLedsCoinPin1;
	uint8_t	creditLedsCoinPin2;
	//uint8_t	creditLedsCoinPin3;
	//uint8_t	creditLedsCoinPin4;
	uint8_t	creditLedsMarqueePin;
	uint8_t creditLedsExtStartPin;
	uint8_t creditLedsExtCoinPin;
	uint8_t creditLedsStartBrightness;
	uint8_t creditLedsCoinBrightness;
	uint8_t creditLedsMarqueeBrightness;
