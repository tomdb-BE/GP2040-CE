...
#define PCCONTROL_SWITCH_MASK GAMEPAD_MASK_A3
#define PCCONTROL_BUTTON_MASK_1 GAMEPAD_MASK_S1
#define PCCONTROL_BUTTON_MASK_2 GAMEPAD_MASK_S2
...
#define Z680_BUTTON_MASK GAMEPAD_MASK_S1
