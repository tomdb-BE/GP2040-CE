export default {
	...
	'coin-leds-header-text': 'Coin Leds Configuration',
	'coin-leds-start-pin-1-label': 'Start P1 Pin LED',
	'coin-leds-start-pin-2-label': 'Start P2 Pin LED',
	'coin-leds-start-pin-3-label': 'Start P3 Pin LED',
	'coin-leds-start-pin-4-label': 'Start P4 Pin LED',	
	'coin-leds-coin-pin-1-label': 'Coin P1 Pin LED',
	'coin-leds-coin-pin-2-label': 'Coin P2 Pin LED',
	'coin-leds-coin-pin-3-label': 'Coin P3 Pin LED',			
	'coin-leds-coin-pin-4-label': 'Coin P4 Pin LED',
	'coin-leds-ext-start-pin-out-label': 'External Start Pin OUT',
	'coin-leds-ext-coin-pin-out-label': 'External Coin Pin OUT',	
	'coin-leds-marquee-pin-label': 'Marquee Pin',	
	'coin-leds-start-mask-1-label': 'Start P1 Button',
	'coin-leds-start-mask-2-label': 'Start P2 Button',
	'coin-leds-start-mask-3-label': 'Start P3 Button',
	'coin-leds-start-mask-4-label': 'Start P4 Button',
	'coin-leds-coin-mask-1-label': 'Coin P1 Button',
	'coin-leds-coin-mask-2-label': 'Coin P2 Button',
	'coin-leds-coin-mask-3-label': 'Coin P3 Button',
	'coin-leds-coin-mask-4-label': 'Coin P4 Button',	
	'coin-leds-ext-start-mask-label': 'External Start Button',	
	'coin-leds-ext-coin-mask-label': 'External Coin Button',
	'coin-leds-start-brightness-label': 'Start LED Brightness',
	'coin-leds-coin-brightness-label': 'Coin LED Brightness',
	...
	'pc-control-button-mask-label': 'Trigger Button',
	'z680-header-text': 'Z680',
	'z680-button-mask-label': 'Trigger Button',
	'z680-power-pin-label': 'Power Switch Pin',
	'z680-volume-up-pin-label': 'Volume Up Pin',
	'z680-volume-down-pin-label': 'Volume Down Pin',
	'z680-mute-pin-label': 'Mute Pin',
	'z680-power-state-pin-label': 'Power State Pin',	
};
